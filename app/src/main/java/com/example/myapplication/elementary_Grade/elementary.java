package com.example.myapplication.elementary_Grade;
...
public class elementary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 버튼 ID 배열
        int[] buttonIds = {R.id.btn5, R.id.btn6, R.id.btn7, R.id.btn8, R.id.btn9, R.id.btn10};

        // 버튼이 이동할 액티비티 클래스 배열
        Class<?>[] activities = {
                first_grade.class, secondg.class, thirdg.class,
                fourthg.class, fifthg.class, sixthg.class
        };
        ...
        Button backButton = findViewById(R.id.btn11);
